...
#Preview {
    VStack {
        SecondaryButton(title: "Title 1", action: nil)
        
        SecondaryButton(title: "Title 2", action: nil)
        
        SecondaryButton(title: "Title 3", action: nil)
        
        SecondaryButton(title: "Title 4", action: nil)
            .disabled(true)
    }
    .padding()
