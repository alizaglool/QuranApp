...
#Preview {
    VStack {
        OutlinedButton(title: "Title 1", action: nil)
        
        OutlinedButton(title: "Title 2", action: nil)
        
        OutlinedButton(title: "Title 3", action: nil)
        
        OutlinedButton(title: "Title 4", action: nil)
            .disabled(true)
    }
    .padding()
