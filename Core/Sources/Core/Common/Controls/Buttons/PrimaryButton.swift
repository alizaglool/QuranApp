...
#Preview {
    VStack {
        PrimaryButton(title: "Title 1", action: nil)
        
        PrimaryButton(title: "Title 2", action: nil)
        
        PrimaryButton(title: "Title 3", action: nil)
        
        PrimaryButton(title: "Title 4", action: nil)
            .disabled(true)
    }
    .padding()
